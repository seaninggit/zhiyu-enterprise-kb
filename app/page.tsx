...
type KnowledgeDocument = {
  ...
  reviewDueAt?: string | null; createdAt: string; updatedAt: string; versions?: DocumentVersion[]; parseStatus?: string; verificationStatus?: string; spaceId?: number | null; folderId?: number | null; canEdit?:boolean;canManage?:boolean;subscribed?:boolean;
};
...
function DocumentDrawer({ document: doc, canRestore, favorite, onClose, onFavorite, onSaved,onRestore, onFeedback, onExport, onDownload, onShare, onSubscribe, onContact }: { document: KnowledgeDocument; canRestore:boolean; favorite: boolean; onClose: () => void; onFavorite: () => void; onSaved:()=>void;onRestore:(version:number)=>void; onFeedback: () => void; onExport: () => void; onDownload: () => void; onShare: () => void; onSubscribe: () => void; onContact: () => void }) {
